...
args <- c(20000, 15000, 5, 3, 100, 2, 2)
...
#               .options.snow=opts) %dopar% {
                ...
                p_delta = sapply(1:q, function(k) rep(0.5, n) ) # 0.8
